## Tooty CMS Attribution

Tooty CMS is based on the [Vercel Platforms Starter Kit](https://github.com/vercel/platforms) and includes custom modifications.

- Original template: Vercel Platforms Starter Kit
- Original authors: Vercel / Steven Tey
- License basis: MIT (retain original license notices when redistributing)
