(function () {
  ...
  document.documentElement.setAttribute("data-tooty-theme", "teety-dark");
  ...
  function renderThemeArtSlots() {
    ...
    slots.forEach((slot) => {
      ...
      const categorySlugs = (context?.getAttribute("data-theme-category-slugs") || "")
        ...
        .filter(Boolean);
      const publicBase = (context?.getAttribute("data-theme-public-image-base") || "/theme-assets/teety-dark").replace(/\/+$/, "");
