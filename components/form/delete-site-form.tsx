...
type Props = {
  siteName: Promise<{ siteName: string }>;
};
export default function DeleteSiteForm({ siteName }: Props) {
  ...
  useEffect(() => {
    (async () => {
      ...
      setResolvedSiteName(result.siteName);
    })();
  }, [siteName]);
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 sm:p-10">
        ...
        <p className="text-sm text-stone-500 dark:text-stone-400">
          ...
          of your site <b>{resolvedSiteName}</b> to confirm.
        </p>
        ...
        <input
          ...
          type="text"
          required
          pattern={resolvedSiteName}
          placeholder={resolvedSiteName}
