...
export const SETUP_ENV_FIELDS: SetupEnvField[] = [
  ...
  { key: "THEMES_PATH", label: "Themes Path(s)", placeholder: "themes,/abs/path/tootyCMS-themes" },
  { key: "PLUGINS_PATH", label: "Plugins Path(s)", placeholder: "plugins,/abs/path/tootyCMS-plugins" },
